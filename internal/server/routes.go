...
func (s *Server) setupRoutes() {
	...
	s.Router.Path("/grid/{token:[A-Za-z0-9_-]{8}}/squares/{square:[0-9]{1,2}}").Methods(http.MethodGet, http.MethodPost).Handler(s.gridMemberHandler(true, false, s.gridSquaresSquareHandler()))
