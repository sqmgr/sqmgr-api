...
ALTER TABLE pools ADD COLUMN number_set_config number_set_config NOT NULL DEFAULT 'standard';
...
SELECT id, 'all'::number_set_type,
       ARRAY(SELECT unnest(home_numbers)::integer),
...
BEGIN
    ...
    VALUES (_token, _user_id, _name, _grid_type, _password_hash, _number_set_config) RETURNING * INTO _row;
